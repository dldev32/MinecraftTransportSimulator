...
public class GUIPackMissing extends AGUIBase {
    ...
    public void setupComponents() {
        ...
        addComponent(new GUIComponentLabel(guiLeft + 10, guiTop + 40, ColorRGB.WHITE, LanguageSystem.GUI_PACKMISSING_TEXT.getCurrentValue(), TextAlignment.LEFT_ALIGNED, 1.0F, 240));
    }
