...
public class JSONConfigSettings {
    ...
    public static class ConfigGeneral {
        ...
        public JSONConfigEntry<Boolean> vehicleStatusPanel = new JSONConfigEntry<>(true, "If enabled, the vehicle status panel will render near vehicles while dev mode is enabled.");
